...
public class TCVideoPreviewActivity extends Activity implements View.OnClickListener, ITXVodPlayListener {
    ...
    private LinearLayout mIvToEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvToEdit = (LinearLayout) findViewById(R.id.record_to_edit);
...
//                    .into(mImageViewBg);
            ...
            if(file.exists()){
                Bitmap bm = BitmapFactory.decodeFile(mCoverImagePath);
                mImageViewBg.setImageBitmap(bm);
            }
        }
...
//            }
            ...
            bean.setKey("video_event_edit_finish");
            bean.setVideopath(mVideoPath);
            bean.setImgpath(mCoverImagePath);
