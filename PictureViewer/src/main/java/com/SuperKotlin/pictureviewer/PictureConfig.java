...
public class PictureConfig {
    ...
    public static boolean needDelelete = false;//是否支持删除
    ...
    public PictureConfig(Builder builder) {
        ...
        this.needDelelete = builder.needDelelete;
    ...
    public static class Builder implements Serializable {
        ...
        private boolean needDelelete = false;
        private int resId = 0;
        ...
        public Builder needDelelete(boolean needDelelete) {
            this.needDelelete = needDelelete;
            return this;
        }
