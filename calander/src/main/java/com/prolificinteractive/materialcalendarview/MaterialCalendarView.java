...
//                   clickLisenter.onClickAll();
//                   setSelectedDate(adapter.setRangeDates());
//                   CalendarDay.
//                   adapter.setDateSelected(day, true);
//                Toast.makeText(getContext(),"wozoule",Toast.LENGTH_LONG).show();
            }else if(v==clear){
                clearSelection();
            }
//            if (v == buttonFuture) {
...
//        buttonPast.setContentDescription(getContext().getString(R.string.previous));
        ...
        clear.setTextColor(context.getResources().getColor(R.color.indicator_selected_color));
        all.setTextColor(context.getResources().getColor(R.color.indicator_selected_color));
...
//        buttonFuture.setOnClickListener(onClickListener);
    ...
    private void setupChildren() {
        ...
        topbar.addView(clear,new LinearLayout.LayoutParams(150, LayoutParams.MATCH_PARENT));
...
//        topbar.addView(buttonFuture, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1));
        ...
        topbar.addView(all,new LinearLayout.LayoutParams(150, LayoutParams.MATCH_PARENT));
//        topbar.addView(new TextView(context),new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1));
...
//        buttonFuture.setImageDrawable(icon);
     ...
     * the previous month button {@link #}, next month button {@link #},
...
//        setSelectionMode(ss.selectionMode);
    ...
    public static class SavedState extends BaseSavedState {
        ...
        int selectionMode = SELECTION_MODE_MULTIPLE;
//        int selectionMode = SELECTION_MODE_SINGLE;
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            ...
            l.selectedData(adapter.getSelectedDates());
        }
//        adapter.getSelectedDates();
    ...
    clickAllLisenter clickLisenter;
    public void setOnAllClickLisenter( clickAllLisenter clickLisenter){
        this.clickLisenter=clickLisenter;

    }
    public interface clickAllLisenter{
