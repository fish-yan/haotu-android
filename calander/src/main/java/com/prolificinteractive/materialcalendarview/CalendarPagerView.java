...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    public CalendarPagerView(@NonNull MaterialCalendarView view,
        ...
        mcv.setOnAllClickLisenter(new MaterialCalendarView.clickAllLisenter() {
            @Override
            public void onClickAll() {
                for (int i=0;i<dayViews.size()-12;i++){
                    final DayView dayView =  (DayView)((ArrayList)dayViews).get(i);
