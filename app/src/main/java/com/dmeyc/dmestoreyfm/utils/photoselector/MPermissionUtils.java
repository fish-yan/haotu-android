...
/**
 * Created by Johnny on 2017/5/24.
 */
...
public class MPermissionUtils {
     ...
     * 显示提示对话框
     */
    public static void showTipsDialog(final Context context, final String content){
        String con = "当前应用缺少读取存储权限(录音,照片,视频等需要),该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。";
