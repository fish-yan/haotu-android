package com.dmeyc.dmestoreyfm.decoration;
...
/**
 * Created by jockie on 2017/11/13.
 */
...
public class HorizontalDecoration extends RecyclerView.ItemDecoration {
    ...
    private int space = DensityUtil.dip2px(20);

    public HorizontalDecoration(boolean isHavehead){
