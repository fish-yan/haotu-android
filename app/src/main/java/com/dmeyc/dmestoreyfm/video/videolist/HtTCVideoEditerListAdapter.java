...
public class HtTCVideoEditerListAdapter extends RecyclerView.Adapter<HtTCVideoEditerListAdapter.ViewHolder> {
    ...
    public HtTCVideoEditerListAdapter(Context context) {
