...
public class HtVideoChooseFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = "HtVideoChooseFragment";
    private RecyclerView mRecyclerView;
    private HtTCVideoEditerListAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.tencent.liteav.demo.videoediter.R.layout.fragment_video_edit, null);
        return view;
    }
    ...
    private void initView() {
        mBtnImport = (Button) getView().findViewById(com.tencent.liteav.demo.videoediter.R.id.btn_import);
        mBtnImport.setOnClickListener(this);
        mBtnFastImport = (Button) getView().findViewById(com.tencent.liteav.demo.videoediter.R.id.btn_fast_import);
        mBtnFastImport.setOnClickListener(this);

        mRecyclerView = (RecyclerView) getView().findViewById(com.tencent.liteav.demo.videoediter.R.id.recycler_view);
        mRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 4));
        mAdapter = new HtTCVideoEditerListAdapter(getActivity());
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == com.tencent.liteav.demo.videoediter.R.id.btn_fast_import) {
            needProcessVideo = false;
        } else if (v.getId() == com.tencent.liteav.demo.videoediter.R.id.btn_import) {
