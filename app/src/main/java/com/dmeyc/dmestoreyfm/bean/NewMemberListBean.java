...
public class NewMemberListBean extends BaseRespBean {
    ...
    public static class DataBean {
        private List<ListBean> managerList;
        private List<ListBean> normalList;

        public List<ListBean> getManagerList() {
            return managerList;
        }

        public void setManagerList(List<ListBean> managerList) {
            this.managerList = managerList;
        }

        public List<ListBean> getNormalList() {
            return normalList;
        }

        public void setNormalList(List<ListBean> normalList) {
