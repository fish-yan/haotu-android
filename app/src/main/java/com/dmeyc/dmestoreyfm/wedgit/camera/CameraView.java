...
public class CameraView<T extends BaseActivity> extends SurfaceView implements SurfaceHolder.Callback, ICameraOperation, IActivityLifiCycle {
    ...
    public CameraView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCameraManager.setCameraDirection(CameraManager.CameraDirection.valueOf(SPUtils.getIntData("SP_CAMERA_DIRECTION", CameraManager.CameraDirection.CAMERA_BACK.ordinal())));
    ...
    private void adjustView(Camera.Size adapterSize ){
      ...
      /*  if(adapterSize.width > adapterSize.height){
            width = height;
            height = adapterSize.width;
        }

        if(width < BaseApp.mScreenWidth){
            height = BaseApp.mScreenHeight * width/BaseApp.mScreenWidth;
            width = BaseApp.mScreenWidth;
        }*/
