...
public class AutoFlowLayout <T> extends ViewGroup {
     ...
     * 水平方向View之间的间距
     */
    private float mHorizontalSpace = DensityUtil.dip2px(20);
    /**
     * 竖直方向View之间的间距
     */
    private float mVerticalSpace = DensityUtil.dip2px(20);
    /**
     * 列数
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHorizontalSpace = ta.getDimension(R.styleable.AutoFlowLayout_horizontalSpace,DensityUtil.dip2px(20));
        mVerticalSpace = ta.getDimension(R.styleable.AutoFlowLayout_verticalSpace, DensityUtil.dip2px(20));
