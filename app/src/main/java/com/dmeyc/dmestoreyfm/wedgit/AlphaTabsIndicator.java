...
public class AlphaTabsIndicator extends LinearLayout {
    ...
    public void setViewPager(ViewPager mViewPager, Window window) {
        ...
        public void onPageSelected(int position) {
           ...
           /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if(position == 4){
                    ...
                    window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);//View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                }else{
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            //点击前先重置所有按钮的状态
//            if(currentIndex >= (mChildCounts - 2) && true){
//                Util.checkLoginStatus(getContext());
//                return;
//            }
            resetState();
