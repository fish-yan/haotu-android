...
public class PickTextView extends TextView {
    ...
    public PickTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initCloseEnd(){
        ...
        ButtonSpan span = new ButtonSpan(getContext(), new View.OnClickListener(){
            ...
            public void onClick(View v) {
                PickTextView.super.setMaxLines(Integer.MAX_VALUE);
                setExpandText(originText);
            }
        }, R.color.liji_material_red_500);
    ...
    private void initExpandEnd(){
        ...
        ButtonSpan span = new ButtonSpan(getContext(), new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                PickTextView.super.setMaxLines(mMaxLines);
    ...
    public class ButtonSpan extends ClickableSpan {
        ...
        public ButtonSpan(Context context, View.OnClickListener onClickListener) {
            this(context, onClickListener, R.color.liji_material_red_700);
        }
