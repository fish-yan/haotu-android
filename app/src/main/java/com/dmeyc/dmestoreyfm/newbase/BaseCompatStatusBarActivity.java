...
public abstract class BaseCompatStatusBarActivity extends AppCompatActivity {
    ...
    private FrameLayout mRlTopView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRlTopView = (FrameLayout) findViewById(R.id.rl_top_view);
    ...
    protected View setTopView(int layoutResID) {
        View contentView = LayoutInflater.from(this).inflate(layoutResID, null);
        mRlTopView.removeAllViews();
        mRlTopView.addView(contentView);
        return contentView;
    }
    ...
    protected int getTopViewVisibility() {
        return mRlTopView.getVisibility();
    }
     ...
     * 设置沉浸式状态栏
     *
     * @param fontIconDark 状态栏字体和图标颜色是否为深色，添加的状态栏高度为0
     */
