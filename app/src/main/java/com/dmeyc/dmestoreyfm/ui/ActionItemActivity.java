...
public class ActionItemActivity extends BaseActivity implements View.OnClickListener, INaviInfoCallback {
...
//    private TabLayout action_ruletablayout;
    ...
    protected void initData() {
        ...
        countdownView.setTextSize(ScreenUtil.dp2px(ActionItemActivity.this, 4));
        ...
        btn_baoming.setBackground(ActionItemActivity.this.getResources().getDrawable(R.drawable.shap_gb));
//        setData();
...
//                        btn_baoming.setBackgroundColor(ActionItemActivity.this.getResources().getColor(R.color.gray_deep));
                            ...
                            btn_baoming.setBackground(ActionItemActivity.this.getResources().getDrawable(R.drawable.shape_tailor_sure));
...
//                    tv_moneywoman.setText("女士优惠"+bean.getData().getW_discount_amount()+"元/人次");
                ...
                LinearLayoutManager lm = new LinearLayoutManager(ActionItemActivity.this);
                lm.setOrientation(OrientationHelper.HORIZONTAL);
                rv_member.setLayoutManager(lm);
                rv_member.setAdapter(new ActionItemActivity.iconAdapter());
                if (activityDeatilBean.getData().getSign_up_no() == activityDeatilBean.getData().getTotal_no()) {
                    btn_baoming.setBackground(ActionItemActivity.this.getResources().getDrawable(R.drawable.shap_gb));
                    return;
                }
            ...
            showTwoButtonDialog("提示\n确认拨打电话：" + activityDeatilBean.getData().getActivity_phone_no() + "吗?", "取消", "确定", new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23) {
                        int checkCallPhonePermission = ContextCompat.checkSelfPermission(ActionItemActivity.this,
                                Manifest.permission.CALL_PHONE);
                        if (checkCallPhonePermission != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(ActionItemActivity.this, new String[]{
                                    Manifest.permission.CALL_PHONE
...
//                    startActivity(intent);
            ...
            strings.add("高德地图");
            strings.add("百度地图");
            StyledDialog.buildBottomItemDialog(ActionItemActivity.this, strings, "cancle", new MyItemDialogListener() {
                @Override
                public void onItemClick(CharSequence text, int position) {

                    if (0 == position) {
                        if (isAvilible(ActionItemActivity.this, "com.autonavi.minimap")) {
...
//                        ToastUtil.show("sss+");
            ...
            startActivity(new Intent(ActionItemActivity.this, ChartInforActivity.class).putExtra("group_id", activityDeatilBean.getData().getGroup_id()));
        } else if (R.id.iv_shopcar == viewid) {
            RongIM.getInstance().startGroupChat(ActionItemActivity.this, activityDeatilBean.getData().getGroup_id() + "", activityDeatilBean.getData().getGroup_name());
        } else if (R.id.iv_share == viewid) {
            if (activityDeatilBean != null && activityDeatilBean.getData() != null) {

                CommSharePopWin dd = new CommSharePopWin.Builder(ActionItemActivity.this).setContent(activityDeatilBean.getData().getActivity_name())
...
//            intent.putExtra(Constant.Config.URL,Constant.API.BASE_URL+Constant.API.USER_AGREEMENT);
            ...
            startActivity(new Intent(ActionItemActivity.this, HasInActionMemBerActivity.class).putExtra("activityid", getIntent().getIntExtra("activityid", -1)).putExtra("isallban", ""));
    ...
    class iconAdapter extends RecyclerView.Adapter<iconAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            GlideUtil.loadImage(ActionItemActivity.this, activityDeatilBean.getData().getSign_up_list().get(position).getUrl(), holder.civ_avatar);
        }
...
//                tv_titl=  itemView.findViewById(R.id.tv_titl);
    ...
    public void startNavi() {
        ...
        if (isAvilible(ActionItemActivity.this, "com.baidu.BaiduMap")) {
            Intent intent = null;
            try {
