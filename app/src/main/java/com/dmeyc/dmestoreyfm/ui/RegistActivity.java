...
//                }
                ...
                RestClient.getYfmNovate(this).post(Constant.API.YFM_USER_RGISET, new ParamMap.Build()
                    ...
                    @Override
                    public void onSuccess(CommonBean bean) {
//                        Toast.makeText(RegistActivity.this,bean.getMsg(),Toast.LENGTH_LONG).show();
                        finish();
//
                    }
            ...
            iv_man.setBackground(RegistActivity.this.getDrawable(R.drawable.man_check));
            iv_woman.setBackground(RegistActivity.this.getDrawable(R.drawable.woman_uncheck));
            sex=1;
          }else if(R.id.iv_woman==viewid){
            sex=2;
            iv_man.setBackground(RegistActivity.this.getDrawable(R.drawable.man_uncheck));
            iv_woman.setBackground(RegistActivity.this.getDrawable(R.drawable.woman_check));
        }
