...
import com.dmeyc.dmestoreyfm.adapter.photo.AlbumChanceActivity;
import com.dmeyc.dmestoreyfm.adapter.photo.AlbumGridViewAdapter;
...
public class PlaceAlbumActivity extends AbsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ispk= extras.getInt("ispk");
        groupid=extras.getInt("groupid");
        activityid= extras.getInt("activityid",-1);
        loadPic();
...
//				AlbumActivity.this.finish();
    ...
    private void initSelectImage() {
        ...
        for (final String path : selectedDataList) {
            ImageView imageView = (ImageView) LayoutInflater.from(PlaceAlbumActivity.this).inflate(R.layout.choose_imageview, selectedImageLayout, false);
        ...
        gridImageAdapter.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final CheckBox toggleButton, int position, final String path, boolean isChecked) {
                if (selectedDataList.size() >= 6) {
                    ...
                    if (!removePath(path)) {
                        Toast.makeText(PlaceAlbumActivity.this, "只能选择6张图片", Toast.LENGTH_SHORT).show();
                    }
                    return;
                }
                if (isChecked) {
