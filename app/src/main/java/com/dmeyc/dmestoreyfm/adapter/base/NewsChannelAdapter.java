package com.dmeyc.dmestoreyfm.adapter.base;
...
import com.dmeyc.dmestoreyfm.listener.ChannelItemMoveEvent;
import com.dmeyc.dmestoreyfm.listener.ItemDragHelperCallback;
import com.dmeyc.dmestoreyfm.listener.OnItemClickListener;
import com.dmeyc.dmestoreyfm.utils.ClickUtil;
import com.dmeyc.dmestoreyfm.utils.RxBus;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (newsChannel.getNewsChannelIndex() == 0) {
            viewHolder.mNewsChannelTv.setTextColor(ContextCompat
                    .getColor(BaseApp.getContext(), getColorId()));
        }
    }
