...
import com.dmeyc.dmestoreyfm.ui.MyCreatCommActivity;
...
public class BClientFragment extends BaseFragment {
...
//SPUtils.getStringData(Constant.Config.AVATAR, "")
    ...
    protected int getLayoutRes() {
        return R.layout.fragment_bclient;
    }
...
//        tv_verson.setText(Util.getLocalVersionName(getActivity())+"");
    ...
    @OnClick({R.id.iv_seting ,R.id.rl_teach_setin,R.id.rl_commin,R.id.rl_placein,R.id.tv_credit,R.id.tv_clear_cash,R.id.tv_about_me,
            ...
            R.id.rl_promotion,R.id.rl_unstart,R.id.rl_staring,R.id.rl_started,R.id.ll_bclientmycomm,R.id.ll_aboutme})
...
//                break;
            case R.id.rl_teach_setin:
                startActivity(new Intent(getActivity(), TeachInActivity.class));
                break;
            case R.id.rl_commin:
...
//                startActivity(new Intent(getActivity(),AboutUsActivity.class));
            ...
            case R.id.rl_vacancy:
                startActivity(new Intent(getActivity(),VacancyActivity.class));
                break;
            ...
            case R.id.rl_started:
                ...
                break;
            case R.id.ll_bclientmycomm:
                startActivity(new Intent(getActivity(),MyCreatCommActivity.class));
                break;
